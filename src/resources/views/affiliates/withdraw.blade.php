                    ...
                    <div class="form-group" style="width:30%">
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1">{{ config('cashier.symbol') }}</span>
                            </div>
                            <input type="number" name="amount" class="form-control" id="withdrawalAmount" placeholder="Amount" aria-describedby="basic-addon1">
                            <small id="amountHelp" class="form-text text-muted">The minimum withdrawal amount is {{ config('cashier.symbol') }}10.</small>
                        </div>
                    </div>
